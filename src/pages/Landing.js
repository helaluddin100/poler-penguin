...
const Landing = () => {
  ...
  // Contract Info
  const CONTRACT_ADDRESS = "0xdC598c3a9cf0CdD8791bc16EaAdBdF7119533235";
  const CONTRACT_ABI = [
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: `Total 10,000 Penguins.`,
    },
    {
      question: "Where do my earnings come from?",
      answer: `Each NFT will represent a share in a Decentralized Financial Investment Group consisting of two main departments. The first one being a solar, off grid and therefor eco-friendly crypto mining facility (currently mining bitcoin as it’s the most profitable ) for short term, passive income. The second department will be metaverse real estate investment for long term capital gains.
        <br/>
      Therefor this is NFT is not a jpeg image, it can rather be described as a share in a decentralised investment group, which pays dividends on a monthly basis. NFTs and smart contracts have made it possible to take the “human factor” out of financial institutions, therefor minimising the overheads of the institution and maximising profits for all shareholders.`,
    },
    {
      question: "PRICE?",
      answer:
        "Pre sale will be 0.05 Ethers and Public sale will be 0.07 Ethers.",
    },
  ];
    ...
    <React.Fragment>
      <main className="landing-page">
          ...
          <div className="container">
            <div className="hero-left">
              ...
              <p>
                ...
                with the mission of taking over.
              </p>
        ...
        <div className="images">
          <div className="image-sliders">
            <div className="image-slider">
              <img src="/images/page-landing/images-img-1.png" alt="" />
              <img src="/images/page-landing/images-img-2.png" alt="" />
              <img src="/images/page-landing/images-img-3.png" alt="" />
              <img src="/images/page-landing/images-img-4.png" alt="" />
              <img src="/images/page-landing/images-img-5.png" alt="" />
              <img src="/images/page-landing/images-img-6.png" alt="" />
              <img src="/images/page-landing/images-img-7.png" alt="" />
              <img src="/images/page-landing/images-img-8.png" alt="" />
              <img src="/images/page-landing/images-img-9.png" alt="" />
              <img src="/images/page-landing/images-img-10.png" alt="" />
            </div>
          ...
          <div className="container">
            <div className="boxes-wrapper">
              <div className="box" data-aos="fade-up">
                <img
                  src="/images/page-landing/stats-img-1.png"
                  alt=""
                  className="box-img"
                />

                <img
                  src="/images/page-landing/stats-box-bg-1.svg"
                  alt=""
                  className="box-bg"
                />
              ...
              <div className="box" data-aos="fade-up" data-aos-delay="100">
                <img
                  src="/images/page-landing/stats-img-2.png"
                  alt=""
                  className="box-img"
                />
              ...
              <div className="box" data-aos="fade-up" data-aos-delay="200">
                <img
                  src="/images/page-landing/stats-img-3.png"
                  alt=""
                  className="box-img"
                />
        ...
        <section className="about">
          <div className="container">
            <h2 data-aos="fade-up">
              <span>IN A VAST PLACE FULL</span> <br /> OF WONDERS BEYOND
              IMAGINATION
            </h2>
            <p data-aos="fade-up">
              10 000 Polar Penguins recently landed on the shores of Africa with
              the mission of taking over. Each penguin represents a share in the
              revenue of a solar powered, fully off-grid bitcoin mining farm.
              This farm uses the latest technology of Bitmain's hydro-cooled
              ASIC miners. Each penguin holder earns up to 30% ROI on their
              investment every year, paid straight into your crypto wallet.
              <br />
              <br />
              Penguins are stored as ERC-721 tokens on the Ethereum blockchain
              and hosted on IPFS.
            </p>

            <img
              src="/images/page-landing/about-img-1.png"
              alt=""
              data-aos="fade-up"
            />
          </div>
          ...
          <img
            src="/images/page-landing/about-bg-element-1.png"
            alt=""
            className="about-bg-element-1"
            data-aos="fade-right"
          />

          <img
            src="/images/page-landing/about-bg-element-2.png"
            alt=""
            className="about-bg-element-2"
            data-aos="fade-left"
          />
        </section>
        ...
        <section className="roadmap">
          <div className="container">
            <h2 data-aos="fade-up">
              <span>Polar Penguins</span> <br /> Ultimate Roadmap
            </h2>
            ...
            <div className="roadmap-rows">
              ...
              >
                <img
                  src="/images/page-landing/roadmap-row-img-1.png"
                  alt="Phase 1"
                />
                ...
                <div className="content">
                  ...
                  <p>
                    Random monthly bonuses to be incorporated: every month, one
                    holder will receive a grand total of $1000 in ETH instead of
              ...
              >
                <div className="content">
                  ...
                  <p>
                    Time to evolve: every 12 months, the the penguins will
                    evolve, moving the holder of that NFT into a higher earnings
                    bracket.
                  </p>
                </div>

                <img
                  src="/images/page-landing/roadmap-row-img-2.png"
                  alt="Phase 2"
                />
              </div>
              ...
              >
                <img
                  src="/images/page-landing/roadmap-row-img-3.png"
                  alt="Phase 3"
                />
                ...
                <div className="content">
                  ...
                  <p>
                    Real time stats: NFT holders have the option to view real
                    time stats on the performance of the miners.
                  </p>
                </div>
              </div>
              ...
              >
                <div className="content">
                  ...
                  <p>
                    THE EASTER EGG HUNT BEGINS: look for clues and flaws
                    throughout the collection's physical appearance to complete
                    the easter egg hunt. The first person to complete the hunt
                    will be rewarded with $3000 in ETH.
                  </p>
                </div>

                <img
                  src="/images/page-landing/roadmap-row-img-4.png"
                  alt="Phase 4"
                />
              </div>
            </div>
